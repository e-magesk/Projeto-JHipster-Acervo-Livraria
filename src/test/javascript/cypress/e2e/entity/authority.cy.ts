...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '74f7d383-fb46-47f4-ac58-a7c8cb8daa0c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('af3c1ff6-93d2-4ea1-9ee1-189dd6da44fb');
      cy.get(`[data-cy="name"]`).should('have.value', 'af3c1ff6-93d2-4ea1-9ee1-189dd6da44fb');
