package org.jhipster.acervolivraria.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.jhipster.acervolivraria.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.jhipster.acervolivraria.repository.UserRepository.USERS_BY_EMAIL_CACHE);
