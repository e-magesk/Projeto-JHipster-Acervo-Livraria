...
import { sampleWithRequiredData } from '../posicao.test-samples';
...
describe('Posicao Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.posicaos()[0]).toEqual(expect.objectContaining({ id: 11868 }));
  });

  describe('trackId', () => {
    it('Should forward to posicaoService', () => {
      const entity = { id: 11868 };
      jest.spyOn(service, 'getPosicaoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPosicaoIdentifier).toHaveBeenCalledWith(entity);
