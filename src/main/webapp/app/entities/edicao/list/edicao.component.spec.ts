...
import { sampleWithRequiredData } from '../edicao.test-samples';
...
describe('Edicao Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.edicaos()[0]).toEqual(expect.objectContaining({ id: 32276 }));
  });

  describe('trackId', () => {
    it('Should forward to edicaoService', () => {
      const entity = { id: 32276 };
      jest.spyOn(service, 'getEdicaoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEdicaoIdentifier).toHaveBeenCalledWith(entity);
