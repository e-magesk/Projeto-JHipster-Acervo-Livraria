...
import { EdicaoService, EntityArrayResponseType } from '../service/edicao.service';
...
export class EdicaoComponent implements OnInit {
  ...
  trackId = (item: IEdicao): number => this.edicaoService.getEdicaoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.edicaos.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IEdicao[] | null): IEdicao[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.edicaoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
