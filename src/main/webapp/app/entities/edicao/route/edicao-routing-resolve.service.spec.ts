...
import edicaoResolve from './edicao-routing-resolve.service';

describe('Edicao routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: EdicaoService;
  let resultEdicao: IEdicao | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IEdicao returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        edicaoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultEdicao = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEdicao).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEdicao>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
